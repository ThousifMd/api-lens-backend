#!/usr/bin/env python3
"""Add gpt-4o model to vendor_models table with slug"""
import asyncio
    ...
    try:
        ...
        async with db_manager.pool.acquire() as conn:
            ...
            if existing_model:
                ...
                # Insert gpt-4o model with slug
                model = await conn.fetchrow("""
                    INSERT INTO vendor_models (
                        vendor_id, name, slug, display_name, description, model_type,
                        context_window, max_output_tokens, supports_functions, supports_vision, is_active
                    ) VALUES (
                        $1, 'gpt-4o', 'gpt-4o', 'GPT-4o', 'Most capable and cost-effective GPT-4 model', 'chat',

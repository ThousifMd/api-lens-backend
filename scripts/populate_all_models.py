...
Updated with latest models as of July 2025
"""
import asyncio
import sys
    ...
    "openai": {
        ...
        "models": [
            ...
            },
            {
                ...
                "training_data_cutoff": "2023-09-01",
                "is_active": True
            },
            {
                "name": "gpt-4-32k",
            ...
            },
            {
                ...
                "supports_vision": False,
                "supports_json_mode": False,
                "training_data_cutoff": "2022-09-01",
                "is_active": True
            },
            ...
            },
            {
                ...
                "supports_vision": False,
                "supports_json_mode": False,
                "training_data_cutoff": "2021-09-01",
                "is_active": True
            }
        ]
    },
    ...
    "anthropic": {
        ...
        "models": [
            ...
            # Claude 3 Models
            {
                ...
                "supports_vision": True,
                "supports_json_mode": False,
                "training_data_cutoff": "2023-08-01",
                "is_active": True
            },
            {
            ...
            # Claude 2 Models (Legacy)
            {
                ...
                "supports_vision": False,
                "supports_json_mode": False,
                "training_data_cutoff": "2023-01-01",
                "is_active": False
            },
            {
                "name": "claude-2.0",
    ...
    "google": {
        ...
        "models": [
            # Gemini 2.0 Models (Latest)
            {
                ...
                "supports_vision": True,
                "supports_json_mode": True,
                "training_data_cutoff": "2024-08-01",
                "is_active": True
            },
    ...
    try:
                ...
                try:
                    ...
                    model_query = """
                        INSERT INTO vendor_models (
                            ...
                            supports_vision, input_cost_per_1k_tokens, output_cost_per_1k_tokens,
                    ...
                    model_result = await DatabaseUtils.execute_query(
                        ...
                        [
                            ...
                            model_data.get('context_length'),           # context_length
                            model_data.get('context_length'),           # max_tokens (same as context_length)
                            True,                                        # supports_streaming (assume true)
                            model_data.get('supports_functions', False), # supports_functions
                            model_data.get('supports_vision', False),   # supports_vision
                            None,                                        # input_cost_per_1k_tokens (to be set later)
                            None,                                        # output_cost_per_1k_tokens (to be set later)
        ...
        summary_query = """
            SELECT 
                ...
                COUNT(*) FILTER (WHERE vm.model_type = 'image_generation') as image_models,
        ...
        for row in summary:
            ...
            print(f"    Chat: {row['chat_models']} | Images: {row['image_models']} | Embeddings: {row['embedding_models']}")
